...
public class Helper {
    ...
    /**
     * @param days is the number of days away from the current date
     * Eg. 45 days from today is future, -45 days from today would be the past
     * @return String of the current date plus "n" number of days
     */
